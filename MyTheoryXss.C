...
void MyTheoryXss(){
  ...
  lambVec4000.push_back(0.000008322);   lambVec4500.push_back(0.000004926);
   ...
   lambVecMlstar.push_back(0.00000294); 
  ...
  for(int i = 0; i<lambdaVecAll.size(); i++){
    ...
    myGraph->Write();
    if(isMuChannel)decorateGraph(myGraph, "M_{l^{*}} [GeV]", "#sigma (fb) #times BR", "", 1000*0.1*lambVec10000.at(12), 1000*100*lambVec500.at(0), i+1);
